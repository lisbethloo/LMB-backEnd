...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    allRoutes: true,
    allowOrigins: ['http://localhost:4200', 'http://localhost:2400'],
    allowCredentials: true,
    allowRequestHeaders: "noauth, authorization, content-type",
    allowRequestMethods: "GET, PATH, PUT, POST, DELETE, OPTIONS, HEAD"
  },
